...
I=[
("Active ransomware encryption","Files encrypted across network shares","Isolate hosts, check EDR for ransomware process, identify jamily","Isolate, disable SMB °¡¬¥¹¥Ñ¥°ÍÌ°ÁÉÍÉÙÙ¥¹°¹%H¥É´°]¥Ñ¡½ÕÐ¥Í½±Ñ¥½¸°¹ÉåÁÑ¥½¸ÍÁÉÌÑ¼±°Í¡ÉÌ¸¤,
