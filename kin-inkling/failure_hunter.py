#!/usr/bin/env python3
"""
Inkling Cybersecurity Failure Case Hunter v4
=============================================
Key fix: Uses sampling_client.get_tokenizer() instead of AutoTokenizer.
        ServiceClient() reads TINKER_API_KEY from env (no api_key param).
        Uses result.sequences[0].tokens for response decoding.
        ASCII-only content to avoid encoding issues.

Tests Thinking Machines' Inkling model via the Tinker API across 25
cybersecurity tasks. Collects failure cases for Tinker credit submission.
"""
...
print("=" * 60, flush=True)
print("INKLING FAILURE HUNTER v4", flush=True)
print("=" * 60, flush=True)
...
print("\n[2/4] Loading tokenizer from sampling client...", flush=True)
try:
    tokenizer = sampling_client.get_tokenizer()
    print(f"  Tokenizer loaded: {type(tokenizer).__name__}", flush=True)
except Exception as e:
    print(f"  FATAL: get_tokenizer failed: {e}", flush=True)
    traceback.print_exc()
    sys.exit(1)
...
try:
    ...
    test_tokens = test_result.sequences[0].tokens
...
TESTS = [
    # 1. Vulnerability Identification - SQL Injection
    {
        "id": "VULN-001",
    ...
    # 3. CVE Hallucination Trap - Fake CVE
    {
        "id": "CVE-002",
    ...
    # 4. CVE Hallucination Trap - Plausible but fake
    {
        "id": "CVE-003",
        "category": "cve_accuracy_hallucination",
    ...
    # 5. Exploit Analysis - Buffer Overflow
    {
        "id": "EXPL-001",
    ...
    # 9. Reverse Engineering - Simple binary
    {
        "id": "RE-001",
    ...
    # 10. Threat Intelligence - APT Attribution
    {
        "id": "THREAT-001",
    ...
    # 12. Network Security - Firewall Rules
    {
        "id": "NET-001",
    ...
    # 13. LLM Security - Prompt Injection
    {
        "id": "LLM-001",
    ...
    # 14. Supply Chain - Dependency Confusion
    {
        "id": "SUPPLY-001",
    ...
    # 15. Mobile Security - Insecure Storage
    {
        "id": "MOBILE-001",
    ...
    # 16. Incident Response - Ransomware
    {
        "id": "IR-011",
    ...
    # 17. Remediation - Fix SQL Injection
    {
        "id": "REM-001",
    ...
    # 18. Vulnerability ID - Path Traversal
    {
        "id": "VULN-002",
        "category": "vulnerability_identification",
    ...
    # 21. Code Review - Deserialization
    {
        "id": "CODE-002",
        "category": "code_review",
    ...
    # 22. Cloud Security - IAM Privilege Escalation
    {
        "id": "CLOUD-002",
        "category": "cloud_security",
    ...
    # 23. Threat Intelligence - Ransomware Group
    {
        "id": "THREAT-002",
        "category": "threat_intelligence",
    ...
    # 24. Network Security - DNS Tunneling
    {
        "id": "NET-002",
        "category": "network_security",
...
for i, test in enumerate(TESTS, 1):
    ...
    try:
        ...
        if passed:
            pass_count += 1
            print(f"  [PASS] matched: {', '.join(matched[:3])}", flush=True)
        else:
            fail_count += 1
            failure_cases.append(result)
            print(f"  [FAIL] expected: {expected[:3]}, got none", flush=True)
